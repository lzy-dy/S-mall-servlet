...
INSERT INTO `config` VALUES (1,'website_name','网站名称','校园商城',100,NULL),(2,'index_description','首页描述','校园商城是一个非常小巧轻便的商城系统',50,NULL),(3,'index_keyword','首页关键词','校园商城,商超系统',25,NULL),(4,'index_title','首页标题','校园商城——基于JavaWeb的商城项目',12,NULL),(5,'path_product_img','产品图片存放目录','pictures/product/',6,NULL),(6,'path_category_img','分类图片存放目录','pictures/category/',5,NULL);
